...
export default function LovePagePresente({
  ...
  const musica = musicaId && musicaTitulo ? {
    id: musicaId,
    title: musicaTitulo,
  ...
  return (
  <div className="min-h-screen bg-gray-900 flex flex-col justify-center items-center text-white pb-24">
    ...
    {/* PLAYER NO RODAPÉ */}
    <MusicPlayerFooter musica={musica} />
