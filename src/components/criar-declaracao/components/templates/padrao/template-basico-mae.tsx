...
function CriadorDeclaracaoInnerDiaDasMaes() {
  const totalEtapas = 9;
        ...
        {etapa === 2 && (
          <>
            ...
            <FormMensagem
              ...
              tituloMensagem="O que você quer dizer pra sua mãe? 💌"
            />
          </>
        )}
...
export function CriadorDeclaracaoDiaDasMaes() {
  return (
    <RetrospectiveProvider>
      <CriadorDeclaracaoInnerDiaDasMaes />
    </RetrospectiveProvider>
  );
}
