          ...
          <div key={i} className="flex flex-col items-center gap-1">
            <div className="w-32 h-20 bg-gray-700 rounded-md flex items-center justify-center overflow-hidden">
              {img ? (
                ...
                <span className="text-gray-400">Quadrado {i + 1}</span>
              )}
            </div>
            <input
              type="file"
  ...
  return (
    <div className="bg-gray-800 rounded-md overflow-hidden text-white">
      ...
      <div className="relative w-full h-120 bg-gray-700">
        {imagemPrincipal && (
          <img src={imagemPrincipal} className="w-full h-full object-cover" />
        )}
      ...
      {/* Episódios */}
      <h1 className="p-3 font-bold flex gap-1 mt-3 ml-2">
        <CiBoxList size={20} className="mt-1" /> Melhores Epídosios
      </h1>
