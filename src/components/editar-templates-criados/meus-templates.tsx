      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div className="flex-1">
            ...
            {usuario && (
              <p className="text-sm text-white/40 mt-0.5">{usuario.email}</p>
            )}
          </div>

          <button
            onClick={() => navigate("/criar")}
            className="flex cursor-pointer items-center gap-2 bg-red-600 hover:bg-red-500 text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-all shadow-lg shadow-pink-900/20"
          >
            <FiPlus size={16} />
            Nova declaração
          </button>
